...
If upgrading from v0.2, read the [Upgrading](#upgrading) section of the [v0.4.0 release notes](https://github.com/decred/dcrdex/releases/tag/v0.4.0) for important information. If upgrading from v0.4, read the [Upgrading](#upgrading) section of this document.
...
- Rescan and recover functionality for the native BTC SPV wallet. You may also now reconfigure the native BTC wallet’s “birthday” to change the scope of the rescan. (<https://github.com/decred/dcrdex/pull/1507>, <https://github.com/decred/dcrdex/pull/1439>)
