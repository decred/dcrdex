...
func newTokener(
	...
	var tokenAddresser interface {
		TokenAddress(opts *bind.CallOpts) (common.Address, error)
	}
	...
	case 0:
		...
		tokenAddresser = es
	case 1:
		es, err := erc20v1.NewERC20Swap(contract.Address, be)
		if err != nil {
			return nil, err
		}
		sc = &swapSourceV1{es}
...
// swap data.
func (s *swapSourceV0) status(ctx context.Context, locator []byte) (*dexeth.SwapStatus, error) {
