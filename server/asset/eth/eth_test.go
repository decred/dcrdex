...
func (n *testNode) getUserOpEvent(ctx context.Context, epAddress common.Address, epVersion dexeth.EntryPointVersion, userOpHash common.Hash, swapContractAddress common.Address, blockNumber uint64) (*userOpEvent, error) {
	return nil, nil
}
