...
func TestParseHandleOps(t *testing.T) {
	...
	userOps, err := ParseV0_6HandleOpsData(calldataB)
	if err != nil {
		t.Fatalf("failed to parse handle ops data: %v", err)
	}

	hash, err := HashV0_6UserOp(userOps[0], common.HexToAddress("0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789"), big.NewInt(11155111))
	if err != nil {
