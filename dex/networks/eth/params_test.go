	...
	tests := []*test{
		{
			...
			expInitGases: []uint64{
				0,
				v0Gases.InitGas,
				v0Gases.InitGas + v0Gases.AdditionalInitGas,
				v0Gases.InitGas + v0Gases.AdditionalInitGas*2,
			},
			expRedeemGases: []uint64{
				0,
				v0Gases.RedeemGas,
				v0Gases.RedeemGas + v0Gases.AdditionalRedeemGas,
				v0Gases.RedeemGas + v0Gases.AdditionalRedeemGas*2,
			},
			expRefundGas: v0Gases.RefundGas,
		},
		{
			ver:            1,
