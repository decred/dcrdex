...
var EntryPoints = map[dex.Network]map[dexeth.EntryPointVersion]common.Address{
	dex.Simnet: {
		dexeth.EntryPointVersion0_6: common.Address{}, // populated by MaybeReadSimnetAddrs
	},
	dex.Testnet: {
		dexeth.EntryPointVersion0_6: common.HexToAddress("0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789"), // txid: 0xf582a60ff370f24e5c2836feeddbf586635282dd7d4e5e972d3d8ca503b47e0e
	},
}
