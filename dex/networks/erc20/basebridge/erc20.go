...
//
// Solidity: function isOperator(address who) view returns(bool)
func (_ERC20 *ERC20Caller) IsOperator(opts *bind.CallOpts, who common.Address) (bool, error) {
	var out []interface{}
	err := _ERC20.contract.Call(opts, &out, "isOperator", who)
...
//
// Solidity: function isOperator(address who) view returns(bool)
func (_ERC20 *ERC20Session) IsOperator(who common.Address) (bool, error) {
	return _ERC20.Contract.IsOperator(&_ERC20.CallOpts, who)
}

// IsOperator is a free data retrieval call binding the contract method 0x6d70f7ae.
//
// Solidity: function isOperator(address who) view returns(bool)
func (_ERC20 *ERC20CallerSession) IsOperator(who common.Address) (bool, error) {
	return _ERC20.Contract.IsOperator(&_ERC20.CallOpts, who)
}
...
// WhitelistOperator is a paid mutator transaction binding the contract method 0x18ea4513.
//
// Solidity: function whitelistOperator(address operator, bool enabled) returns()
func (_ERC20 *ERC20Transactor) WhitelistOperator(opts *bind.TransactOpts, operator common.Address, enabled bool) (*types.Transaction, error) {
	return _ERC20.contract.Transact(opts, "whitelistOperator", operator, enabled)
}

// WhitelistOperator is a paid mutator transaction binding the contract method 0x18ea4513.
//
// Solidity: function whitelistOperator(address operator, bool enabled) returns()
func (_ERC20 *ERC20Session) WhitelistOperator(operator common.Address, enabled bool) (*types.Transaction, error) {
	return _ERC20.Contract.WhitelistOperator(&_ERC20.TransactOpts, operator, enabled)
}

// WhitelistOperator is a paid mutator transaction binding the contract method 0x18ea4513.
//
// Solidity: function whitelistOperator(address operator, bool enabled) returns()
func (_ERC20 *ERC20TransactorSession) WhitelistOperator(operator common.Address, enabled bool) (*types.Transaction, error) {
	return _ERC20.Contract.WhitelistOperator(&_ERC20.TransactOpts, operator, enabled)
}
...
// ERC20WhitelistedOperatorIterator is returned from FilterWhitelistedOperator and is used to iterate over the raw logs and unpacked data for WhitelistedOperator events raised by the ERC20 contract.
type ERC20WhitelistedOperatorIterator struct {
	Event *ERC20WhitelistedOperator // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ERC20WhitelistedOperatorIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ERC20WhitelistedOperator)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ERC20WhitelistedOperatorIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ERC20WhitelistedOperatorIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ERC20WhitelistedOperator represents a WhitelistedOperator event raised by the ERC20 contract.
type ERC20WhitelistedOperator struct {
	Operator common.Address
	Enabled  bool
	Raw      types.Log // Blockchain specific contextual infos
}

// FilterWhitelistedOperator is a free log retrieval operation binding the contract event 0x68d3992ad51e852ec24f4f7d106d7886d715a58e71176bc329cea3d11e7f08e4.
//
// Solidity: event WhitelistedOperator(address operator, bool enabled)
func (_ERC20 *ERC20Filterer) FilterWhitelistedOperator(opts *bind.FilterOpts) (*ERC20WhitelistedOperatorIterator, error) {

	logs, sub, err := _ERC20.contract.FilterLogs(opts, "WhitelistedOperator")
	if err != nil {
		return nil, err
	}
	return &ERC20WhitelistedOperatorIterator{contract: _ERC20.contract, event: "WhitelistedOperator", logs: logs, sub: sub}, nil
}

// WatchWhitelistedOperator is a free log subscription operation binding the contract event 0x68d3992ad51e852ec24f4f7d106d7886d715a58e71176bc329cea3d11e7f08e4.
//
// Solidity: event WhitelistedOperator(address operator, bool enabled)
func (_ERC20 *ERC20Filterer) WatchWhitelistedOperator(opts *bind.WatchOpts, sink chan<- *ERC20WhitelistedOperator) (event.Subscription, error) {

	logs, sub, err := _ERC20.contract.WatchLogs(opts, "WhitelistedOperator")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ERC20WhitelistedOperator)
				if err := _ERC20.contract.UnpackLog(event, "WhitelistedOperator", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseWhitelistedOperator is a log parse operation binding the contract event 0x68d3992ad51e852ec24f4f7d106d7886d715a58e71176bc329cea3d11e7f08e4.
//
// Solidity: event WhitelistedOperator(address operator, bool enabled)
func (_ERC20 *ERC20Filterer) ParseWhitelistedOperator(log types.Log) (*ERC20WhitelistedOperator, error) {
	event := new(ERC20WhitelistedOperator)
	if err := _ERC20.contract.UnpackLog(event, "WhitelistedOperator", log); err != nil {
		return nil, err
	}
