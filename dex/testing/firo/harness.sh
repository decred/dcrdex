...
BETA_MINING_ADDR="TVncMftCQstJFzPNzbAPjcrvgbaKSf4XVt"
...
echo "Generating 350 blocks for alpha"
tmux send-keys -t $SESSION:4 "./alpha generatetoaddress 350 ${ALPHA_MINING_ADDR}${DONE}" C-m\; ${WAIT}
...
echo "Sending some FIRO funds to other wallets in 8 transactions each"
