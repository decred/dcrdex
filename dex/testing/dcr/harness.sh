...
ALPHA_RPC_PORT="19561"
ALPHA_WALLET_PORT="19562"
...
${ALPHA_WALLET_PORT} ${USE_SPV} ${ENABLE_TICKET_BUYER} ${ALPHA_WALLET_HTTPPROF_PORT}
...
${BETA_WALLET_PORT} ${USE_SPV} ${ENABLE_TICKET_BUYER} ${BETA_WALLET_HTTPPROF_PORT}
