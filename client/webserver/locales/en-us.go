...
var EnUS = map[string]string{
	...
	"enable_wallet_message":       "This wallet will resume operation and might take some time to sync. This will also enable the parent wallet if this is a token wallet.",
	"Disabled":                    "Disabled",
