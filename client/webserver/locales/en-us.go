...
var EnUS = map[string]string{
	...
	"archived_date_time_tooltip":  "Archived orders and matches created before your specified and date and time will be deleted from the database. Note: If an invalid date or time is provided, all archived records till date will be deleted.",
