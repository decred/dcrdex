...
var EnUS = map[string]string{
	...
	"Error":                  "Error",
	"register_api_keys":      "Register API Keys",
	"update_api_keys":        "Update API Keys",
	"disconnect":             "Disconnect",
	"manage_cexes":           "Manage CEXes",
	"enter_api_keys":         `Enter <span id="apiKeysCexLbl"></span> API Keys`,
	"api_key":                "API Key",
	"api_secret":             "API Secret",
	"cex_balances":           `<span id="cexBalancesFormLbl"></span> Balances`,
	`cex_balances_2`:         ` <div class="demi fs14 mb-1"><span id="balancesCexName"></span> balances`,
	"Available":              "Available",
	"Locked":                 "Locked",
	"cex_markets":            `<span id="cexMarketsLbl"></span> Markets`,
	"lots_available":         "Lots available",
	"bot_type":               "Bot Type:",
	"gap_market_maker":       "Gap Market Maker",
	"arbitrage_bot":          "Arbitrage Bot",
	"no_cex_connected":       "You have not yet connected any CEXes.",
	"cex":                    "CEX",
	"no_cex_market":          `<span id="noMarketCexName"></span> does not have a <span id="noMarketBase"></span>-<span id="noMarketQuote"></span> market.`,
}
