...
var EnUS = map[string]string{
	...
	"reg_confirm_submit": `Enter your app password to confirm DEX registration.
		...
		registration fees.`,
	"lot_size_headsup": `The DCR lot size for this DEX is <span id="dexDCRLotSize"></span> DCR.
	...
	"reg_confirm_msg":    `Enter your app password to confirm DEX registration. When you submit this form, <span id="feeDisplay"></span> DCR will be spent from your Decred wallet to pay registration fees.`,
	"reg_lot_size_hint": `The DCR lot size for this DEX is <span id="dexDCRLotSize"></span> DCR.
			All trades are in multiples of this lot size.
			This is the minimum possible trade amount in DCR.`,
	"Dark Mode":                 "Dark Mode",
