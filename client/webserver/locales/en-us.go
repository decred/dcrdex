...
var EnUS = map[string]string{
	...
	"reg_confirm_submit":             `When you submit this form, <span id="feeDisplay"></span> will be spent from your Decred wallet to pay registration fees.`, // TODO for multi-asset reg
