...
var PlPL = map[string]string{
	...
	"Submit":                         "Wyślij",
	"Confirm Registration":           "Potwierdź rejestrację",                                                                                           // stale but better than no translation
	"app_pw_reg":                     "Podaj hasło aplikacji, aby potwierdzić rejestrację na DEX.",                                                      // stale...
	"reg_confirm_submit":             `Po wysłaniu tego formularza środki z Twojego portfela zostaną wykorzystane do zapłacenia opłaty rejestracyjnej.`, // stale...
	...
	"disable_dex_server":             "Ten serwer DEX może zostać ponownie włączony w dowolnym momencie w przyszłości, dodając go ponownie.",
