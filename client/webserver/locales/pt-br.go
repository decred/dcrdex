...
var PtBr = map[string]string{
	...
	"Submit":                         "Enviar",
	"Confirm Registration":           "Confirma Registro",                                                                                                                    // stale but better than no translation
	"app_pw_reg":                     "Informe sua senha do app para confirmar seu registro na DEX.",                                                                         // stale...
	"reg_confirm_submit":             `Quando vc enviar esse formulário, <span id="feeDisplay"></span> DCR será gasto de sua carteira decred para pagar a taxa de registro.`, // stale...
	...
	"disable_dex_server":             "Este servidor DEX pode ser reativado a qualquer momento no futuro, adicionando-o novamente.",
