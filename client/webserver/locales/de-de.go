...
var DeDE = map[string]string{
	...
	"app_password_helper":            "Dein App-Passwort wird immer bei der Durchführung sensibler Walletoperationen benötigt.",
	"Add":                            "Hinzufügen",
	"Unlock":                         "Entsperren",
	"Rescan":                         "Neu scannen",
	"Wallet":                         "Wallet",
	...
	"Send funds for token":        `Deposit at least <span data-tmpl="tokenFees"></span> <span class="unit">XYZ</span> and <span data-tmpl="parentFees"></span> <span data-tmpl="parentUnit">XYZ</span> to also cover fees. You may deposit as much as you like to your wallet, since only the required amount will be used in the next step. The deposit must confirm to proceed.`, // karamble
