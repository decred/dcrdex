...
export const ID_MATCH_STATUS_MATCH_COMPLETE = 'MATCH_STATUS_MATCH_COMPLETE'
export const ID_MATCH_STATUS_REDEMPTION_CONFIRMED = 'MATCH_REDEMPTION_CONFIRMED'
export const ID_MATCH_STATUS_UNKNOWN = 'MATCH_STATUS_UNKNOWN'
...
export const enUS: Locale = {
  ...
  [ID_MATCH_STATUS_UNKNOWN]: 'Unknown Match Status',
