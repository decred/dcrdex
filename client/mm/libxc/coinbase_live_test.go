...
func TestWithdraw(t *testing.T) {
	...
	withdrawalID, amount, err := c.Withdraw(ctx, 966001, 10e6, "0xd9cc38723a1143B9b1C40E6e0E26503578FcFcCD")
	if err != nil {
		t.Fatal(err)
	}
...
func TestConfirmWithdrawal(t *testing.T) {
	...
	withdrawalID := "e48ce513-c2ae-58b1-a9bb-ca9bc151f235"
	for {
		amt, txID, err := c.ConfirmWithdrawal(ctx, withdrawalID, 966001)
...
func TestGetDepositAddress(t *testing.T) {
	...
	addr, err := c.GetDepositAddress(ctx, 133)
	if err != nil {
